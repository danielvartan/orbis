...
#> ! Failed to get data for year 2010.
#> 
#> Error message: Timeout was reached [apisidra.ibge.gov.br]: Failed to connect to apisidra.ibge.gov.br port 443 after 10001 ms: Timeout was reached
#> ⠙ Downloading data from 2010
#> ✔ Downloading data from 2010 [10s]
#> 
#> ⠙ Downloading data from 2011
#> All others arguments are desconsidered when 'api' is informed
#> ! Failed to get data for year 2011.
#> 
#> Error message: Timeout was reached [apisidra.ibge.gov.br]: Failed to connect to apisidra.ibge.gov.br port 443 after 10002 ms: Timeout was reached
#> ⠙ Downloading data from 2011
#> ✔ Downloading data from 2011 [10s]
#> 
#> Rows: 0
#> Columns: 0
# }
