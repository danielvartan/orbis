...
- [`shift_and_crop()`](https://danielvartan.github.io/orbis/dev/reference/shift_and_crop.md)
  : Shift, rotate, and crop a SpatVector or a SpatRaster
- [`shift_and_rotate()`](https://danielvartan.github.io/orbis/dev/reference/shift_and_rotate.md)
...
- [`sidra_download_by_year()`](https://danielvartan.github.io/orbis/dev/reference/sidra_download_by_year.md)
...
- [`brazil_municipality()`](https://danielvartan.github.io/orbis/dev/reference/brazil_municipality.md)
...
- [`country_names()`](https://danielvartan.github.io/orbis/dev/reference/country_names.md)
  : Get country names
...
- [`worldclim_download()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_download.md)
  : Download WorldClim data
- [`worldclim_extract_variable()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_extract_variable.md)
  [`worldclim_extract_resolution()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_extract_variable.md)
  [`worldclim_extract_month()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_extract_variable.md)
  [`worldclim_extract_year()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_extract_variable.md)
  [`worldclim_extract_year_month()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_extract_variable.md)
  [`worldclim_extract_year_group()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_extract_variable.md)
  [`worldclim_extract_gcm()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_extract_variable.md)
  [`worldclim_extract_ssp()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_extract_variable.md)
  : Extract components from WorldClim file names
- [`worldclim_file()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_file.md)
  : Get file paths to WorldClim data
- [`worldclim_random()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_random.md)
  : Return a random WorldClim data selection
- [`worldclim_to_ascii()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_to_ascii.md)
  : Convert WorldClim GeoTIFF files to Esri ASCII Grid
- [`worldclim_url()`](https://danielvartan.github.io/orbis/dev/reference/worldclim_url.md)
...
- [`fix_postal_code()`](https://danielvartan.github.io/orbis/dev/reference/fix_postal_code.md)
  : Fix postal codes

- [`remove_unique_outliers()`](https://danielvartan.github.io/orbis/dev/reference/remove_unique_outliers.md)
  : Remove unique outliers from raster files

- [`test_date_line()`](https://danielvartan.github.io/orbis/dev/reference/test_date_line.md)
  : Test if a spatial object crosses the international date line

- [`test_geobr_connection()`](https://danielvartan.github.io/orbis/dev/reference/test_geobr_connection.md)
  :

  Test `geobr` package connection with its server

- [`unique_outliers()`](https://danielvartan.github.io/orbis/dev/reference/unique_outliers.md)
