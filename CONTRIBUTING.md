...
First of all, thank you for considering a contribution to `orbis`! Your
interest and involvement are what make it rewarding for us—the project
maintainers—to continue developing and improving `orbis`.

`orbis` is an open source project, maintained by people who care. We are
...
If you find `orbis` helpful, please consider starring the repository on
GitHub. It helps others discover the project and shows your support!

### Share `orbis` with Others 📣

Think `orbis` is useful? Let others discover it, by telling them in
...
If you want to support `orbis` and its development, consider [sponsoring
the project](https://github.com/sponsors/danielvartan). Your support
helps us maintain and improve the project, and it allows us to dedicate
more time to its development. Don’t forget to mention `orbis` in your
sponsorship message.

### Cite `orbis` in Your Work 📝

Are you using `orbis` in a publication or project? Please consider
[citing it](https://danielvartan.github.io/orbis/authors.html).
Citations help support the project and demonstrate its impact to the
community.

### Propose an Idea 💡

Have an idea for a new `orbis` feature? Take a look at the
[documentation](https://danielvartan.github.io/orbis) and [issue
list](https://github.com/danielvartan/orbis/issues) to see if it isn’t
included or suggested yet. If not, suggest your idea as an [issue on
GitHub](https://github.com/danielvartan/orbis/issues). While we can’t
...
Using `orbis` and discovered a bug? That’s annoying! Don’t let others
have the same experience and report it as an [issue on
GitHub](https://github.com/danielvartan/orbis/issues/new) so we can fix
...
The [website](https://danielvartan.github.io/orbis) is generated with
...
1.  Go to the `R` directory in the [code
    repository](https://github.com/danielvartan/orbis).
...
Care to fix bugs or implement new functionality for `orbis`? Awesome! 👏
Have a look at the [issue
list](https://github.com/danielvartan/orbis/issues) and leave a comment
...
Conduct](https://danielvartan.github.io/orbis/CODE_OF_CONDUCT.md). By
...
1.  Fork [this repo](https://github.com/danielvartan/orbis) and clone it
