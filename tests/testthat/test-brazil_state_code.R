testthat::test_that("brazil_state_code() | General test", {
  ...
  brazil_state_code("ac") |> testthat::expect_equal(12)
  brazil_state_code("acre") |> testthat::expect_equal(12)
  brazil_state_code(355) |> testthat::expect_equal(35)
  brazil_state_code(3550308) |> testthat::expect_equal(35)
  brazil_state_code(35503081) |> testthat::expect_equal(NA_integer_)
