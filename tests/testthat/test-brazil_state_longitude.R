testthat::test_that("`brazil_state_longitude()` | General test", {
  ...
  brazil_state_longitude("acre") |> testthat::expect_equal(-67.8220778)
  brazil_state_longitude("ac") |> testthat::expect_equal(-67.8220778)

  brazil_state_longitude("sp") |> testthat::expect_equal(-46.6333824)
  brazil_state_longitude("sao paulo") |> testthat::expect_equal(-46.6333824)
  brazil_state_longitude(35) |> testthat::expect_equal(-46.6333824)
  brazil_state_longitude(3550308) |> testthat::expect_equal(-46.6333824)
  brazil_state_longitude(35503081) |> testthat::expect_equal(NA_real_)
  brazil_state_longitude(3912345) |> testthat::expect_equal(NA_real_)
