...
`orbis` provides tools for spatial data analysis in R. It follows [tidyverse principles](https://tidyverse.tidyverse.org/articles/manifesto.html) and is designed to work with the [r-spatial](https://r-spatial.org/) collection of packages.
